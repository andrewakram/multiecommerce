...
Route::get('/del-domain' , function(){

//    $cpanel = new CPanel('magic-solution.net', 'magics16', 'A712boali712@@', 2083, true);
//    return $cpanel->delSubdomain('hema2.magic-solution.net','magic-solution.net');
});
...
Route::group(['domain' => '{subdomain}.' . env('APP_PROTOCOLESS_URL')], function () {
    ...
    Route::group(['namespace' => 'Frontend'], function () {
        ...
        Route::post('/make-review/{id}', 'ReviewController@store')->middleware('auth', 'throttle:1,1');
...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin'], function () {
    Route::get('/make_local', 'AdminController@make_local');
});
