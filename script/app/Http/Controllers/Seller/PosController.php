...
class PosController extends Controller
{
    ...
    {
        $brands=Category::where('user_id',Auth::id())->where('type','brand')->get();
        $categories=Category::where('user_id',Auth::id())->where('type','category')->get();

        return view('seller.pos.index',compact('brands','categories'));
