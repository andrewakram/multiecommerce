...
class CPanel extends HTTP
{
     ...
     * @return cPanel
     */
    function __construct($host, $username, $password, $port = 2082, $ssl = false, $theme = 'x')
    {
    ...
    function addSubdomain($subdomain, $domain)
    {
        ...
        echo 'add here';
        $response = $this->HTTP->getData('execute/SubDomain/addsubdomain', $data, false);
        return json_decode($response[10], true);
     ...
     * @return bool
     */
    function delSubdomain($subdomain , $domain)
    {
        $data['domain'] = $subdomain;
