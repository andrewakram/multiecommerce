          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                ...
                <img src="{{ asset('uploads/logo2.png') }}" height="100" width="200">
              </a>
              </td>
            </tr>
            <!-- Email Body -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                        ...
                        <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td>
                              <h3 class="align-right">{{ $info->created_at->format('Y-m-d') }}</h3>
                            </td>
                          </tr>
                          ...
                          <tr>
                           ...
                           <tr>
                            ...
                            <td>
                              <h3 class="align-right">@if($info->status==1) Approved @elseif($info->status==2) Pending @else Declined  @endif</h3>
                            </td>
                          </tr>
                          <tr>
                            <td>
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell" align="center">
                      ...
                      <p class="f-fallback sub align-center">&copy; {{ date('Y') }} {{ env('APP_NAME') }}. All rights reserved.</p>
