				...
				<form id="basicform" method="post" action="{{ route('admin.menu.store') }}">
					...
					<div class="custom-form">
						<div class="form-group">
							<label for="name">{{ __('Menu Name') }} ({{ __('Arabic') }})</label>
							<input type="text" name="name_ar" class="form-control" id="name" placeholder="Menu Name">
						</div>
                        <div class="form-group">
                            <label for="name">{{ __('Menu Name') }} ({{ __('English') }})</label>
                            <input type="text" name="name_en" class="form-control" id="name" placeholder="Menu Name">
                        </div>
