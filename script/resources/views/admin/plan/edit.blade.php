@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Edit Plan')])
@endsection
@section('content')
<div class="row">
					...
					<div class="row">
						<div class="col-sm-8">
							<div class="form-group">
								<label>{{ __('Plan Name') }} ({{ __('Arabic')}})</label>
								<input type="text" name="name_ar" class="form-control" required value="{{ $info->name_ar }}">
							</div>

                            <div class="form-group">
                                <label>{{ __('Plan Name') }} ({{ __('English')}})</label>
                                <input type="text" name="name_en" class="form-control" required value="{{ $info->name_en }}">
                            </div>

							<div class="form-group">
								<label>{{ __('Plan description') }} ({{ __('Arabic')}})</label>
								<input type="text" class="form-control" required="" name="description_ar" value="{{ $info->description_ar }}"></textarea>
							</div>

                            <div class="form-group">
                                <label>{{ __('Plan description') }} ({{ __('English')}})</label>
                                <input type="text" class="form-control" required="" name="description_en" value="{{ $info->description_en }}"></textarea>
                            </div>
