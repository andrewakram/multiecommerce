...
@endpush
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Language')])
@endsection
@section('content')
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<span class="text-center">{{__('Note:')}} <span class="text-danger">{{ __('If You Already Created Language In Before It Will Replace It From First') }}</span></span>
			</div>
		</div>
	</div>
</div>
