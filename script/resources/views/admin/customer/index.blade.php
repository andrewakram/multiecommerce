        ...
        <div class="float-right">
          <form>
            ...
            <div class="input-group mb-2">
              ...
              <input type="text" id="src" class="form-control" placeholder="{{__('Search...')}}" required="" name="src" autocomplete="off" value="{{ $request->src ?? '' }}">
              ...
              <tbody>
                ...
                <tr id="row{{ $row->id }}">
                  ...
                  <td><a href="mailto:{{ $row->email }}">{{ $row->email }}</a></td>
                    <td><b class="badge badge-{{$row->shop_type == 1 ?  "info" : "success"}}">{{$row->shop_type == 1 ?  __('shop') : __('restaurant')}}</b></td>
