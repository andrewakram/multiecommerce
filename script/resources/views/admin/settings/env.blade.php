@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('System Environment Settings')])
@endsection
@section('content')
<div class="row">
	<div class="col-sm-12">
		<div class="card">
			<div class="card-header">
				<h4>{{__('Note:')}} <span class="text-danger">{{ __('Dont Use Any Kind Of Space In The Input Fields') }}</span></h4>
			</div>
			<div class="card-body">
				<div class="row">
							...
							<div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
								...
								<div class="form-group">
									...
									<select class="form-control" name="MULTILEVEL_CUSTOMER_REGISTER">
										<option value="true" @if(env('MULTILEVEL_CUSTOMER_REGISTER') == true) selected @endif>{{__('true')}}</option>
										<option value="false" @if(env('MULTILEVEL_CUSTOMER_REGISTER') == false) selected @endif>{{__('false')}}</option>
									</select>
								</div>
