		...
		<div class="modal-content">
			...
			<form method="post" class="basicform_with_reload" action="{{ route('admin.appearance.store') }}">
				...
				<div class="modal-body">
					...
					<div class="fom-group">
						<label>{{ __('Description') }} ({{ __('Arabic') }})</label>
						<textarea required="" class="form-control h-200" name="description_ar" placeholder="Short Description"></textarea>
					</div>
                    <div class="fom-group">
                        <label>{{ __('Description') }} ({{ __('English') }})</label>
                        <textarea required="" class="form-control h-200" name="description_en" placeholder="Short Description"></textarea>
                    </div>
				</div>
