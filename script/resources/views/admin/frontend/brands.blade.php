		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="add-new-btn">
					<a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal">{{ __('Add New Brand') }}</a>
				</div>
			</div>
		...
		<div class="modal-content">
			...
			<form method="post" class="basicform_with_reload" action="{{ route('admin.appearance.store') }}">
				...
				<div class="modal-body">
					...
					<div class="fom-group">
						<label>{{ __('Url') }} ({{ __('Arabic') }})</label>
						<input type="text" name="name_ar" class="form-control" required="">
					</div>
                    <div class="fom-group">
                        <label>{{ __('Url') }} ({{ __('English') }})</label>
