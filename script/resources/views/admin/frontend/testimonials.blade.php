		...
		<div class="modal-content">
			...
			<form class="basicform_with_reload" method="post" action="{{ route('admin.appearance.store') }}">
				...
				<div class="modal-body">
					...
					<div class="fom-group">
						<label>{{ __('Name') }} ({{ __('Arabic') }})</label>
						<input type="text" name="name_ar" class="form-control" required="">
					</div>
                    <div class="fom-group">
                        <label>{{ __('Name') }} ({{ __('English') }})</label>
                        <input type="text" name="name_en" class="form-control" required="">
                    </div>

					<div class="fom-group">
						<label>{{ __('Position') }} ({{ __('Arabic') }})</label>
						<input type="text" name="position_ar" class="form-control" required="">
					</div>
                    <div class="fom-group">
                        <label>{{ __('Position') }} ({{ __('English') }})</label>
