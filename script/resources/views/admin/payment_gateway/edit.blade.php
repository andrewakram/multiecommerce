@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Edit').$info->name])
@endsection
@section('content')
<div class="row">
          ...
          <div class="row">
            <div class="col-sm-8">
             ...
             <div class="form-group">
               ...
               <select class="form-control" name="status">
                 <option value="1" @if($info->featured === 1) selected="" @endif>{{__('Enable')}}</option>
                 <option value="0" @if($info->featured === 0) selected="" @endif>{{__('Disable')}}</option>
               </select>
             </div>
             @endif
            ...
            <div class="col-sm-4">
              <div class="form-group col-12">
                <label>{{__('Choose Thumbnail')}}</label>
