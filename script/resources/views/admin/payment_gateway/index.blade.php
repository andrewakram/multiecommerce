@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Payment Gateway')])
@endsection
@section('content')
<div class="row">
              ...
              <tbody>
                ...
                <tr>
                  <td><img src="{{ asset($row->preview->content ?? '') }}" alt="" height="50" width="120"></td>
                	...
                	<td>
{{--                        {{ $row->slug }}--}}
                        <a href="{{ route('admin.payment-geteway.show',$row->slug) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                    </td>
                </tr>
                @endforeach
              </tbody>
