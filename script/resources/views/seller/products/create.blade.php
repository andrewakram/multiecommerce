@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Create Product')])
@endsection
@section('content')
		...
		<form method="post" action="{{ route('seller.product.store') }}" id="product_create">
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-3">
							<label for="price" class="mt-2">{{ __('Product Title') }} ({{__('Arabic')}})</label>
						</div>
						<div class="form-group col-md-9 col-12">

							<input type="text" class="form-control"  placeholder="{{ __('Product Title') }} ({{__('Arabic')}})"  name="title_ar" required>

						</div>
					</div>
                        <div class="row">
                            <div class="col-md-3">
                                <label for="price" class="mt-2">{{ __('Product Title') }} ({{__('English')}})</label>
                            </div>
                            <div class="form-group col-md-9 col-12">

                                <input type="text" class="form-control"  placeholder="{{ __('Product Title') }} ({{__('English')}})"  name="title_en" required>
					...
					<div class="row">
						...
						<div class="form-group col-md-9 col-12">
							...
							<input type="number" step="any" class="form-control" id="price" placeholder="{{ __('Price') }}"  name="price" required="">
					...
					<div class="row">
						...
						<div class="form-group col-md-9 col-12">
							...
							<input type="number"  class="form-control" id="qty" placeholder="{{ __('Stock Quantity') }}"  name="stock_qty" >
