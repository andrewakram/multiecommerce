								...
								<div class="col-12 col-md-8 col-lg-8">
									...
									<div class="form-group">
										...
										<div class="selectgroup w-100">
										   ...
										   <input type="radio" name="variation[{{ $row->category_id }}]" value="{{ $row->variation->id }}" class="selectgroup-input" >
                                               @if(app()->getLocale() == 'ar')
										            <span class="selectgroup-button">{{ $row->variation->name_ar }}</span>
                                               @else
                                                    <span class="selectgroup-button">{{ $row->variation->name_en }}</span>
                                               @endif
										   </label>
										   @endforeach
										</div>
									...
									<div class="form-group">
										<label class="form-label">
                                            ...
                                            @if($option->is_required == 1) <span class="text-danger">*</span> @endif</label>
										<div class="selectgroup w-100">
