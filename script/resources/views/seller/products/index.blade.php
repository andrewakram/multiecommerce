@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Products')])
@endsection
@section('content')
@php
		...
		<div class="float-right">
			<form>
				<div class="input-group mb-2">
					...
					<input type="text" id="src" class="form-control" placeholder="{{__('Search...')}}" required="" name="src" autocomplete="off" value="{{ $src ?? '' }}">
