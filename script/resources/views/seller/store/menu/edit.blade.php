@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Menus')])
@endsection
@section('content')
						...
						<div class="save-menu float-right" >
							<form  class="float-right basicform" method="post" action="{{ route('seller.menu.update',$info->id) }}"> @csrf @method('PUT') <input type="hidden" name="data" id="data">
								...
								<div class="input-group mb-2">
									...
									<input type="text" id="name" class="form-control" placeholder="{{__('Name')}}" value="{{ $info->name }}" required="" name="name" autocomplete="off" value="">
