@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Seo And Sitemap')])
@endsection
@section('content')
@php
...
<div class="card"  >
	<div class="card-body">
			...
			<div class="custom-form">
				<div class="row">
					<div class="form-group col-lg-6">
						...
						<input type="text" name="title"  id="title" class="form-control" value="{{ $info->title }}" placeholder="{{ __('Site Title') }}">
					</div>
					<div class="form-group col-lg-6">
					...
					<div class="form-group col-lg-6">
						...
						<input type="text" name="canonical"  id="canonical" class="form-control" value="{{ $info->canonical }}" placeholder="{{ __('Canonical URL') }}">
					</div>
					<div class="form-group col-lg-6">
						<label for="tags">{{ __('Tags') }}</label>
						<input type="text" name="tags"  id="tags" class="form-control" value="{{ $info->tags }}" placeholder="{{ __('Tags') }}">
					</div>
		...
		<form class="basicform" action="{{ route('seller.seo.store') }}">
			@csrf
