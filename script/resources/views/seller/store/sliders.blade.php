@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Sliders')])
@endsection
@section('content')
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-right"><a href="{{ route('seller.slider.show',$row->id) }}" class="btn btn-danger  cancel"><i class="fa fa-trash"></i></a></td>
					</tr>
					@endforeach
				</tbody>
