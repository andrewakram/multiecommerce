...
@endpush
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Payment Options')])
@endsection
@section('content')
<div class="row">
          ...
          <div class="col-12 col-sm-12 col-md-8">
            <div class="tab-content no-padding" id="myTab2Content">
              ...
              <div class="tab-pane fade" id="profile4" role="tabpanel" aria-labelledby="profile-tab4">
                  <span class="text-danger">{{__('Note:')}} {{ __('before activating the payment gateway make sure your currency is supported with your currency') }}</span>
               <table class="table table-hover card-table">
                <tbody>
