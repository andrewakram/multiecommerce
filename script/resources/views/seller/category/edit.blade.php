@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Categories')])
@endsection
@section('content')
<div class="row">
  <div class="col-12">
      ...
      <div class="card-body">
        <form class="basicform" action="{{ route('seller.category.update',$info->id) }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Name') }} ({{ __('Arabic') }})</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" required="" name="name_ar" value="{{ $info->name_ar }}">
            </div>
          </div>
            <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Name') }} ({{ __('English') }})</label>
                <div class="col-sm-12 col-md-7">
                    <input type="text" class="form-control" required="" name="name_en" value="{{ $info->name_en }}">
                </div>
            </div>
          <div class="form-group row mb-4">
