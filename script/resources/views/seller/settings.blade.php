@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>trans('Profile Settings')])
@endsection
@section('content')
<div class="card">
    <div class="card-body">
        ...
        <form method="post" class="basicform" action="{{ route('my.profile.update') }}">
            ...
            <div class="custom-form">
                <div class="form-group">
                    ...
                    <input type="password" name="password_current" id="oldpassword" class="form-control"  placeholder="{{ __('Old Password') }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password_confirmation" id="password1" class="form-control"  placeholder="{{ __('Enter Again Password') }}" required>
                </div>
                <div class="form-group">
