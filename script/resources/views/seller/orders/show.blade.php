		...
		@endif
			...
			<div class="card-body">
					...
					<li class="list-group-item">
						...
						<li class="list-group-item">
							<div class="row align-items-center">
								...
								<div class="col-3 text-right"> {{ amount_format($order_content->coupon_discount) }} </div>
							</div>
						</li>
						<li class="list-group-item">
							<div class="row align-items-center">
								<div class="col-9 text-right">{{ __('Subtotal') }}</div>
								<div class="col-3 text-right"> {{ amount_format($order_content->sub_total) }} </div>
							</div>
						</li>
						<li class="list-group-item">
							<div class="row align-items-center">
				...
				<div class="card-footer">
					...
					<button type="submit" class="btn btn-primary float-right mt-2 ml-2 basicbtn">{{ __('Save') }}</button>
