                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="login-brand">
                                <a href="{{ url('/') }}"><img src="{{ asset('uploads/logo2.png') }}"
                                                              alt="{{ env('APP_NAME') }}" width="100"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-1">
                                                <input type="radio" id="shop_type1" name="shop_type" value="1" class="">
                                            </div>
                                            <div class="form-group col-5">
                                                <label for="shop_type1"
                                                       class="d-block">{{ __('Are you a shop ?') }}</label>
                                            </div>
                                            <div class="form-group col-1">
                                                <input type="radio" id="shop_type2" name="shop_type" value="2" class="">
                                            </div>
                                            <div class="form-group col-5">
                                                <label for="shop_type2"
                                                       class="d-block">{{ __('Are you a restaurant ?') }}</label>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="domain"
                                                               placeholder="{{ __('Protocol Less Domain') }}">
