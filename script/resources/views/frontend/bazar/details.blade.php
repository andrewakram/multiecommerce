...
@push('css')
<link rel="stylesheet" href="{{ asset('frontend/bazar/css/slick.css') }}">
<link rel="stylesheet" href="{{ asset('frontend/bazar/css/lightgallery.css') }}">
@endpush
@section('content')
...
@endsection
@push('js')
<script src="{{ asset('frontend/bazar/js/elevateZoom.js') }}"></script>
<script src="{{ asset('frontend/bazar/js/lightgallery.js') }}"></script>
<script src="{{ asset('frontend/bazar/js/details.js') }}"></script>
@endpush