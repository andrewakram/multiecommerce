       ...
       <div class="container">
           ...
           <div class="primary-nav">
               ...
               <a class="main-logo" href="{{ url('/') }}">
                   ...
                   <img style="width: 144px; height: 64px;" src="{{ asset('uploads/'.domain_info('user_id').'/logo.png') }}" alt=""></a>
               <!--====== End - Main Logo ======-->
               ...
               <form class="main-form" action="{{ url('/shop') }}">
                   ...
                   <input class="input-text input-text--border-radius input-text--style-2  src" value="{{ $src ?? '' }}" name="src" type="text" id="main-search" placeholder="Search">
               ...
               <div class="menu-init" id="navigation">
                  @if(env('MULTILEVEL_CUSTOMER_REGISTER') == true)
                   <button class="btn btn--icon text-white toggle-button toggle-button--white fas fa-cogs" type="button"></button>
                   @endif
                   <!--====== Menu ======-->
           ...
           <div class="secondary-nav">
            ...
            @endif
               ...
               <div class="menu-init" id="navigation2">
                   ...
                   <button class="btn btn--icon text-white toggle-button toggle-button--white fas fa-cog" type="button"></button>
                   ...
                   <div class="ah-lg-mode">
                       ...
                       <ul class="ah-list ah-list--design2 ah-list--link-color-white">
                        {{ ThemeMenu('header','frontend.bazar.components.menu') }}
                       </ul>
                       <!--====== End - List ======-->
                   </div>
                   <!--====== End - Menu ======-->
               ...
               <div class="menu-init" id="navigation3">
                   ...
                   <button class="btn btn--icon text-white toggle-button toggle-button--white fas fa-shopping-bag toggle-button-shop" type="button"></button>
