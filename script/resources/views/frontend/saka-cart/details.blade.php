...
@push('css')
<link rel="stylesheet" href="{{ asset('frontend/saka-cart/css/slick.css') }}">
<link rel="stylesheet" href="{{ asset('frontend/saka-cart/css/lightgallery.css') }}">
@endpush
@section('content')
...
@endsection
@push('js')
<script src="{{ asset('frontend/saka-cart/js/elevateZoom.js') }}"></script>
<script src="{{ asset('frontend/saka-cart/js/lightgallery.js') }}"></script>
<script src="{{ asset('frontend/saka-cart/js/details.js') }}"></script>
@endpush
