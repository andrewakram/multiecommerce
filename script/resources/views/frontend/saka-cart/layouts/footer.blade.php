            ...
            <div class="col-lg-8 col-md-6">
               <div class="row">
                  <div class="col-lg-4 col-md-4">
                     {{ ThemeFooterMenu('left','frontend.saka-cart.components.footer_menu') }}
                  </div>
                  <div class="col-lg-4 col-md-4">
                     {{ ThemeFooterMenu('center','frontend.saka-cart.components.footer_menu') }}
                  </div>
                  <div class="col-lg-4 col-md-4">
                     {{ ThemeFooterMenu('right','frontend.saka-cart.components.footer_menu') }}
                  </div>
               </div>
            </div>
