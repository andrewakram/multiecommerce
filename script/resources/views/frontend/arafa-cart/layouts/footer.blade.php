            ...
            <div class="col-lg-8 col-md-6">
               <div class="row">
                  <div class="col-lg-4 col-md-4">
                     {{ ThemeFooterMenu('left','frontend.arafa-cart.components.footer_menu') }}
                  </div>
                  <div class="col-lg-4 col-md-4">
                     {{ ThemeFooterMenu('center','frontend.arafa-cart.components.footer_menu') }}
                  </div>
                  <div class="col-lg-4 col-md-4">
                     {{ ThemeFooterMenu('right','frontend.arafa-cart.components.footer_menu') }}
                  </div>
               </div>
            </div>
...
{{--                  <span>{{ __('Copyright') }} &copy; {{ date('Y') }}. {{ __('All rights reserved by') }}</span> <a href="{{ url('/') }}">{{ Cache::get(domain_info('user_id').'shop_name',env('APP_NAME')) }}</a>--}}
{{--               </div>--}}
{{--               </div>--}}
{{--            </div>--}}
{{--         </div>--}}
