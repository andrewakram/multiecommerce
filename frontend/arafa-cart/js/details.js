        ...
        $.ajax({
            ...
            success: function(response) {
               ...
               if (response.get_latest_products.length > 0) {
                   render_products('.new_product',response.get_latest_products); 
                }
                else{
                ...
                if (response.get_related_products.length > 0) {
                   render_products('.related_product',response.get_related_products);
                }
                else{
